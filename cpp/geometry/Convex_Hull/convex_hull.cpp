/*
    ...
    Eliminate redundant points from the hull if REMOVE_REDUNDANT is defined.
    Running time: O(n log n)
    INPUT:   a vector of input points, unordered.
    OUTPUT:  a vector of points in the convex hull, counterclockwise, starting with bottommost/leftmost point
*/
#include <bits/stdc++.h>
using namespace std;
